...
func handleResquest() {
	...
	http.HandleFunc("/prediction2", executeNodosApi)
...
var bitacora = []string{"localhost:9000", "localhost:9001"}
...
func executeNodos(){
	...
	go func() {
		...
		fmt.Println(msg)
		info := Info{"NUMERO", ticket, direccion_nodo}
...
func executeNodosApi(res http.ResponseWriter, req *http.Request){
...
func executeProcess(){
	...
	//	getPersons()
	//}else{
		machineLearningProcess("60", "0", "1", "100", "200")
		fmt.Println("\n---------MACHINE LEARNING------------")
	//	machineLearningProcess()
//	}
...
func machineLearningProcess(agea string, sexa string, blooda string, cholesterola string, depressiona string){
